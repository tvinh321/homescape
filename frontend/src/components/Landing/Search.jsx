...
export default function Search() {
  ...
  return (
    <div className="bg-white w-4/5 shadow-lg rounded-xl">
            ...
            <div className="flex">
              <div className="relative w-full">
                ...
                <input
                  type="search"
                  id="search-dropdown"
                  className="block px-4 py-3 pl-10 w-full z-20 text-gray-900 rounded-lg border bg-gray-100 border-neutral-300 font-semibold"
              ...
              <button
                type="submit"
                className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none font-medium rounded-lg ml-4 px-4 py-2 transition-all duration-200 w-32"
